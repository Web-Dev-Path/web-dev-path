...
export const ContactUsFormSubscribe = ({ setMsg }: SetMessage) => {
  return (
    <MailchimpSubscribe
...
function ContactUsForm({ subscribe, setResponseMessage }: SetSubscribe) {
  const contactReCaptchaRef = useRef<any>();
  ...
  async function onSubmit(data) {
    ...
    if (!contactReCaptchaRef?.current) return;
